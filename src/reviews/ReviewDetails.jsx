            ...
            {review ? (
                <div className={"w-full"}>
                    ...
                    <div className={"flex justify-center gap-5"}>
                        ...
                        {
                            review.game.genres.map((genre) => <p className={"text-2xl"} key={genre.id}>{genre.name}</p>)
                        }
                    </div>
                    ...
                    <p className={"text-1xl"}> {review.review}</p>
                    <div className={"flex text-center mt-5 gap-5 justify-center"}>
                        <Link className={"hover:underline"} to={`/reviews/${review.id}/edit`}>Bewerk deze notitie</Link>
